...
#End Region
                ...
                If intBytesToRead > 0 Then
                    ...
                    Select Case mInputFileEncoding
                        Case clsBinaryTextReader.InputFileEncodingConstants.Ascii
                            Return System.Convert.ToString(System.Text.Encoding.ASCII.GetChars(bytData, 0, intBytesToRead))
                        Case clsBinaryTextReader.InputFileEncodingConstants.UTF8
                            Return System.Convert.ToString(System.Text.Encoding.UTF8.GetChars(bytData, 0, intBytesToRead))
                        Case clsBinaryTextReader.InputFileEncodingConstants.UnicodeNormal
                            Return System.Convert.ToString(System.Text.Encoding.Unicode.GetChars(bytData, 0, intBytesToRead))
                        Case clsBinaryTextReader.InputFileEncodingConstants.UnicodeNormal
                            Return System.Convert.ToString(System.Text.Encoding.BigEndianUnicode.GetChars(bytData, 0, intBytesToRead))
                        Case Else
                            ' Unknown encoding
                            Return String.Empty
                    End Select
    ...
    Protected Function InitializeRegEx(ByVal strPattern As String) As System.Text.RegularExpressions.Regex
        Return New System.Text.RegularExpressions.Regex(strPattern, Text.RegularExpressions.RegexOptions.Compiled Or _
    ...
    Public Overrides Function OpenFile(ByVal strInputFilePath As String) As Boolean
        ...
        Try
            ...
            If mBinaryTextReader.OpenFile(mInputFilePath, IO.FileShare.Read) Then
                ...
                mBinaryReader = New System.IO.FileStream(mInputFilePath, IO.FileMode.Open, IO.FileAccess.Read, IO.FileShare.Read)
