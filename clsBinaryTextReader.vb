...
#End Region
	...
	Public Function OpenFile(ByVal InputFilePath As String, ByVal share As IO.FileShare) As Boolean
		...
		Try
			...
			mBinaryReader = New IO.FileStream(mInputFilePath, IO.FileMode.Open, IO.FileAccess.Read, share)
						...
						Select Case mInputFileEncoding
							Case InputFileEncodingConstants.Ascii, InputFileEncodingConstants.UTF8
								...
								Else
									If mInputFileEncoding = InputFileEncodingConstants.UTF8 Then
										...
										mCurrentLineText = Convert.ToString(System.Text.Encoding.UTF8.GetChars(mByteBuffer, intMatchingTextIndexStart, intBytesToRead))
									Else
										' Extract the data between intMatchingTextIndexStart and intMatchingTextIndexEnd, excluding any line terminator characters
										mCurrentLineText = Convert.ToString(System.Text.Encoding.ASCII.GetChars(mByteBuffer, intMatchingTextIndexStart, intBytesToRead))
									End If
								End If
							...
							Case InputFileEncodingConstants.UnicodeNormal
								...
								If intBytesToRead <= 0 Then
									...
									mCurrentLineText = String.Empty
								Else
									mCurrentLineText = Convert.ToString(System.Text.Encoding.Unicode.GetChars(mByteBuffer, intMatchingTextIndexStart, intBytesToRead))
								End If
							...
							Case InputFileEncodingConstants.UnicodeBigEndian
								...
								If intBytesToRead <= 0 Then
									...
									mCurrentLineText = String.Empty
								Else
									mCurrentLineText = Convert.ToString(System.Text.Encoding.BigEndianUnicode.GetChars(mByteBuffer, intMatchingTextIndexStart, intBytesToRead))
								End If
