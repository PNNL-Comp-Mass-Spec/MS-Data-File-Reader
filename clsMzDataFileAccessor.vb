...
#Region "Classwide Variables"
    Protected mXmlFileReader As clsMzDataFileReader

    Protected mCurrentSpectrumInfo As clsSpectrumInfoMzData

    Protected mInputFileStatsSpectrumIDMinimum As Integer
    Protected mInputFileStatsSpectrumIDMaximum As Integer

    Protected mXmlFileHeader As String
    Protected mAddNewLinesToHeader As Boolean

    Protected mSpectrumStartElementRegEx As System.Text.RegularExpressions.Regex
    Protected mSpectrumEndElementRegEx As System.Text.RegularExpressions.Regex

    Protected mSpectrumListRegEx As System.Text.RegularExpressions.Regex
    Protected mAcquisitionNumberRegEx As System.Text.RegularExpressions.Regex
    Protected mSpectrumIDRegEx As System.Text.RegularExpressions.Regex
    ...
    Protected mIndexedSpectraSpectrumIDToIndex As Hashtable
#End Region
...
#End Region
            ...
            Do While Not (blnMatchFound Or mAbortProcessing)
                ...
                If mInFileCurrentCharIndex + 1 < mInFileCurrentLineText.Length Then
                    ...
                    If mAddNewLinesToHeader Then
                        ...
                        intCharIndex = mInFileCurrentLineText.IndexOf(SPECTRUM_LIST_START_ELEMENT, mInFileCurrentCharIndex + 1)
                    ...
                    If blnLookForScanCountOnNextRead Then
                        ...
                        Else
                            ...
                            If strScanCountSearchText.IndexOf(">") >= 0 Then
                                blnLookForScanCountOnNextRead = False
                            End If
                        End If
                    End If

                    If eElementMatchMode = clsMSDataFileAccessorBaseClass.emmElementMatchModeConstants.EndElement AndAlso Not blnAcqNumberFound Then
                    ...
                    If objMatch.Success Then
                        ...
                        If eElementMatchMode = emmElementMatchModeConstants.StartElement Then
                            ...
                            Else
                                ...
                                If strInFileCurrentLineSubstring.IndexOf(SPECTRUM_END_ELEMENT) < 0 Then
                                    blnMatchFound = False
            ...
            ElseIf mDataReaderMode = clsMSDataFileReaderBaseClass.drmDataReaderModeConstants.Indexed Then
                If GetSpectrumReadyStatus(True) Then
                    ...
                    Else
                        ...
                        objIndex = mIndexedSpectraSpectrumIDToIndex(intSpectrumID)
    ...
    Protected Function ReadMZDataFile() As Boolean
    ...
    Protected Overloads Sub UpdateFileStats(ByVal intScanCount As Integer, ByVal intScanNumber As Integer, ByVal intSpectrumID As Integer)
