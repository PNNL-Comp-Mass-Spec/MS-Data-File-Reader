...
#Region "Classwide Variables"
    Protected mDataFileOrTextStream As System.IO.TextReader
    Protected mXMLReader As System.Xml.XmlTextReader
    ...
    Protected mParentElementStack As System.Collections.Stack
...
#End Region
    ...
    Public Shared Function ConvertTimeFromTimespanToXmlDuration(ByVal dtTimeSpan As TimeSpan, ByVal blnTrimLeadingZeroValues As Boolean, Optional ByVal bytSecondsValueDigitsAfterDecimal As Byte = 3) As String
        ...
        Dim reSecondsRegEx As System.Text.RegularExpressions.Regex
        ...
        Try
            ...
            Else
                ...
                If bytSecondsValueDigitsAfterDecimal < 9 Then
                    ' Look for "M\.\d+S"
                    reSecondsRegEx = New System.Text.RegularExpressions.Regex("M(\d+\.\d+)S")
    ...
    Protected Function GetAttribTimeValueMinutes(ByVal strAttributeName As String) As Single
        ...
        Try
            dtTimeSpan = ConvertTimeFromXmlDurationToTimespan(GetAttribValue(strAttributeName, "PT0S"), New System.TimeSpan(0))
    ...
    Protected Overrides Sub InitializeLocalVariables()
        ...
        If mParentElementStack Is Nothing Then
            mParentElementStack = New System.Collections.Stack
        Else
    ...
    Protected Sub ParentElementStackAdd(ByRef objXMLReader As System.Xml.XmlTextReader)
                   ...
                   mXMLReader.ReadState = Xml.ReadState.Interactive)
                    ...
                    If blnReadSuccessful AndAlso mXMLReader.ReadState = Xml.ReadState.Interactive Then
                        ...
                        If mXMLReader.LineNumber - intLastProgressUpdateLine >= 100 Or mSpectrumFound Then
                            ...
                            If TypeOf mDataFileOrTextStream Is System.IO.StreamReader Then
                                With CType(mDataFileOrTextStream, System.IO.StreamReader)
